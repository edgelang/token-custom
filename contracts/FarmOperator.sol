...
contract FarmOperator is PeggyToken{
    ...
    function adminSTokenMintFreeApprove(uint256 amount) public{
        ...
        StandardHashrateToken(address(_stokenContract)).mint(_pendingMintAccount,_pendingMintAmount);
    ...
    function adminSTokenMintLockedApprove(uint256 amount) public{
        ...
        StandardHashrateToken(address(_stokenContract)).mintWithTimeLock(_pendingMintAccount,_pendingMintAmount);
    ...
    function adminSTokenOwnerSafeTransfer(address pendingTo) public{
        ...
        StandardHashrateToken(address(_stokenContract)).transferOwnership(address(pendingTo));
    }
